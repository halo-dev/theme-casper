<#include "default.ftl">
<@default title="友情链接 | ${options.blog_title}" keyword="${options.seo_keywords}" desc="${options.seo_desc?if_exists}" canonical="${options.blog_url}/links" body_class="page-template">
