<#include "default.ftl">
<@default title="${post.postTitle} | ${options.blog_title}" keyword="${options.seo_keywords}" desc="${post.postSummary?if_exists}" canonical="${options.blog_url}/p/${post.postUrl}" body_class="page-template">
